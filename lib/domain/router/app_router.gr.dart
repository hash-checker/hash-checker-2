...
class AppRouter extends _i3.RootStackRouter {
  ...
  final Map<String, _i3.PageFactory> pagesMap = {
    CalculatorPageRoute.name: (routeData) {
      return _i3.MaterialPageX<dynamic>(routeData: routeData, child: const _i1.CalculatorPage());
    },
    SettingsPageRoute.name: (routeData) {
      return _i3.MaterialPageX<dynamic>(routeData: routeData, child: const _i2.SettingsPage());
    }
  };
...
class CalculatorPageRoute extends _i3.PageRouteInfo<void> {
  const CalculatorPageRoute() : super(CalculatorPageRoute.name, path: '/');
...
class SettingsPageRoute extends _i3.PageRouteInfo<void> {
  const SettingsPageRoute() : super(SettingsPageRoute.name, path: '/settings-page');
