...
import 'package:hash_checker_2/domain/config/app_config.dart';
...
import 'package:hash_checker_2/pages/settings/page/dialogs/select_app_theme_dialog.dart';
import 'package:hash_checker_2/pages/settings/store/settings_store.dart';
import 'package:hash_checker_2/ui/widgets/app_settings_list_item.dart';
            ...
            children: [
              Observer(
                builder: (_) => AppSettingsListItem(
                  title: 'Theme',
                  subtitle: _store!.currentTheme!.uiName,
                  onTap: () async {
